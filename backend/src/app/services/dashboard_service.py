...
DASHBOARD_MARK_TYPE_ORDER = [
    MarkType.CONTENT_OPEN.value,
    MarkType.DOWNLOAD_CLICK.value,
    MarkType.POPUP_OPEN.value,
    ...
    MarkType.WEB_DOWNLOAD_RESUME_CLICK.value,
    MarkType.WEB_DOWNLOAD_IGNORE_CLICK.value,
